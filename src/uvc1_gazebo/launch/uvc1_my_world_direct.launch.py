...
def generate_launch_description():
    ...
    d435i_scan_node = Node(
        ...
        parameters=[
            {
                "use_sim_time": True,
                "output_frame": "base_link",  # This corrects the 60-degree tilt
                "range_min": 1.8,  # Large offset to avoid seeing the robot
                "range_max": 8.0,
                "scan_height": 1,
    ...
    ld.add_action(d435i_scan_node)  # Add second depthimage_to_laserscan node
