...
#  from the D455 depth camera, then feeds it to AMCL for localization.
#
...
#    ros2 launch uvc1_gazebo bringup_launch_amcl_d455.py map_name:=house1
#
#    # With explicit sim time:
#    ros2 launch uvc1_gazebo bringup_launch_amcl_d455.py map_name:=house1 use_sim_time:=true
#
#    # Real robot:
#    ros2 launch uvc1_gazebo bringup_launch_amcl_d455.py map_name:=house1 use_sim_time:=false
#
#  WHAT IT LAUNCHES:
...
#
#  Standard Nav2 bringup with AMCL localization.
#  Uses depthimage_to_laserscan to generate /scan from D455 depth camera.
#
...
#  But our URDF TF tree has "camera_d455_depth_optical_frame".
...
def generate_launch_description():
    ...
    # =========================================================================
    # STATIC TF: camera_d455_depth_optical_frame → camera_depth_frame
    #
    ...
    # "camera_d455_depth_optical_frame" in the TF tree.
    #
    # This identity transform (all zeros) tells TF they are the same frame.
    # Parent: camera_d455_depth_optical_frame (exists in URDF TF tree)
    ...
    # =========================================================================
    # depthimage_to_laserscan  (D455 depth → /scan)
    #
    # Verified topic names from `ros2 topic list`:
    #   /d455/depth/d455_depth/depth/image_raw
    #   /d455/depth/d455_depth/depth/camera_info
    # =========================================================================
    depth_to_scan = Node(
        ...
        parameters=[
            {
                ...
                "scan_time": 0.033,
                # Range limits — match D455 depth clip in URDF
                "range_min": 0.6,  # D455 depth clip near = 0.6m
                "range_max": 6.0,  # D455 depth clip far = 6.0m
