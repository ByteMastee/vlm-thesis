...
4. Otherwise, return the 2D goal coordinate (x, y) for the robot to navigate to.
...
def parse_response(response_text):
    ...
    if "NOT_FOUND" in response_text.strip():
    ...
    return object_name, goal_x, goal_y
...
def main():
    ...
    while True:
        ...
        object_name, goal_x, goal_y = parse_response(raw_response)
